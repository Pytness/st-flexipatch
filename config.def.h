...
static const char* colorname[] = {
    ...
    "#323232", "#e8a1a2", "#9ce4a5", "#e2e3a5", "#a1a2e1", "#e8a1e0", "#9ae3e5", "#ffffff",
...
#if VIM_BROWSE_PATCH
const unsigned int currentBg = 6, buffSize = 2048;
/// Enable double / triple click yanking / selection of word / line.
const int mouseYank = 1, mouseSelect = 0;
/// [Vim Browse] Colors for search results currently on screen.
const unsigned int highlightBg = 160, highlightFg = 15;
const char wDelS[] = "!\"#$%&'()*+,-./:;<=>?@[\\]^`{|}~", wDelL[] = " \t";
...
const unsigned int amountNmKeys = sizeof(nmKeys) / sizeof(*nmKeys);
